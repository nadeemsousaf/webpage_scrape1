...
Message to Self: Look into XML files, try to improve efficiency when scraping to pull less data as entire HTML not needed. Clean up error handling, looks real bad. Add GUI representation?
